...
| **20** | [`20-Near-Me-Keyword-Decision.md`](20-Near-Me-Keyword-Decision.md) | Decision + live data: why `{model} near me` does not belong on model pages, and where to catch "near me" intent instead |
